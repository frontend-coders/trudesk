...
function mainRoutes (router, middleware,authJwt, controllers) {
  ...
  router.post('/tickets/uploadmdeimage', middleware.redirectToLogin, controllers.tickets.uploadImageMDE)  // Messages
  ...
  router.get('/messages/:convoid', middleware.redirectToLogin, middleware.loadCommonData, controllers.messages.view)  // Accounts
  router.get(
    '/profile',
    middleware.redirectToLogin,
    middleware.csrfCheck,
  ...
  // router.post('/accounts/import/ldap/bind', middleware.redirectToLogin, controllers.accounts.bindLdap)  // Groups
  ...
  router.get('/groups/:id', middleware.redirectToLogin, middleware.loadCommonData, controllers.groups.edit)  // Teams
  router.get('/teams', middleware.redirectToLogin, middleware.loadCommonData, controllers.teams.get)  // Departments
  router.get('/departments', middleware.redirectToLogin, middleware.loadCommonData, controllers.departments.get)  // Reports
  ...
  router.get('/plugins', middleware.redirectToLogin, middleware.loadCommonData, controllers.plugins.get)  // API
  // v1
...
}module.exports = function (app, middleware,authJwt) {
  mainRoutes(router, middleware,authJwt, controllers)
  app.use('/', router)  // Load Plugin routes
