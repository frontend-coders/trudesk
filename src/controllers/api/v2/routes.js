...
module.exports = function (middleware, router, controllers) {
  ...
  const verifyToken = middleware.ver
  ...
  const canUser = middleware.canUser  // Common
  ...
  //router.get('/api/v2/accounts/allacc', controllers.api.v2.common.accounts)
  // Accounts
  ...
  router.put('/api/v2/accounts/:username', apiv2Auth, canUser('accounts:update'), apiv2.accounts.update)  // Ticket Info
  router.get('/api/v2/tickets/info/types', apiv2Auth, apiv2.tickets.info.types)  // Tickets
  router.get('/api/v2/tickets', apiv2Auth, canUser('tickets:view'), apiv2.tickets.get)
  router.post('/api/v2/tickets', apiv2Auth, canUser('tickets:create'), apiv2.alltickets.create)
  ...
  router.delete('/api/v2/tickets/deleted/:id', apiv2Auth, isAdmin, apiv2.tickets.permDelete)  // Groups  router.get('/api/v2/groups/all', apiv2.groups.get)
  ...
  router.delete('/api/v2/groups/:id', apiv2Auth, canUser('groups:delete'), apiv2.groups.delete)  // Teams
  ...
  router.delete('/api/v2/teams/:id', apiv2Auth, canUser('teams:delete'), apiv2.teams.delete)  // Departments
  ...
  router.delete('/api/v2/departments/:id', apiv2Auth, canUser('departments:delete'), apiv2.departments.delete)  // Notices
  ...
  router.delete('/api/v2/messages/conversations/:id', apiv2Auth, apiv2.messages.deleteConversation)  // ElasticSearch
  ...
  router.post('/api/v2/tickets/addnote', apiv2Auth, canUser('tickets:notes'), apiv2.tickets.postInternalNote)
}
